...
export function registerWebRoutes(m: Router): void {
  ...
  m.get('/org/:org/settings/hooks', reqSignIn, org.Webhooks);
  m.post('/org/:org/settings/hooks/delete', reqSignIn, org.DeleteWebhook);
  m.get('/org/:org/settings/hooks/:type/new', reqSignIn, repo.WebhooksNew);
  m.post('/org/:org/settings/hooks/gogs/new', reqSignIn, repo.WebhooksNewPost);
  m.post('/org/:org/settings/hooks/slack/new', reqSignIn, repo.WebhooksSlackNewPost);
  m.post('/org/:org/settings/hooks/discord/new', reqSignIn, repo.WebhooksDiscordNewPost);
  m.post('/org/:org/settings/hooks/dingtalk/new', reqSignIn, repo.WebhooksDingtalkNewPost);
  m.get('/org/:org/settings/hooks/:id', reqSignIn, org.WebhooksEdit);
  m.post('/org/:org/settings/hooks/gogs/:id', reqSignIn, repo.WebhooksEditPost);
  m.post('/org/:org/settings/hooks/slack/:id', reqSignIn, repo.WebhooksSlackEditPost);
  m.post('/org/:org/settings/hooks/discord/:id', reqSignIn, repo.WebhooksDiscordEditPost);
  m.post('/org/:org/settings/hooks/dingtalk/:id', reqSignIn, repo.WebhooksDingtalkEditPost);
